...
ActiveRecord::Schema[7.0].define(version: 2023_05_29_230835) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "employee_task_assignments", force: :cascade do |t|
    t.bigint "employee_id", null: false
    t.bigint "task_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["employee_id"], name: "index_employee_task_assignments_on_employee_id"
    t.index ["task_id"], name: "index_employee_task_assignments_on_task_id"
  end
  ...
  add_foreign_key "employee_task_assignments", "employees"
  add_foreign_key "employee_task_assignments", "tasks"
